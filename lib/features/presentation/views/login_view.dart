...
import 'package:login/core/helpers/screen_helper.dart';
import 'package:login/core/helpers/ui_helpers.dart';
import 'package:login/features/presentation/scoped_models/login_model.dart';
import 'package:login/features/presentation/scoped_models/login_view_model.dart';
...
class _LoginViewViewState extends State<LoginViewView> {
  ...
  void validate(LoginSCModel model) async {
